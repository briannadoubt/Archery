...
public final class FeatureFlagManager {
    ...
    public private(set) var flags: [String: Any] = [:]
    public private(set) var overrides: [String: Any] = [:]
...
public struct FeatureFlagModifier<Flag: FeatureFlag>: ViewModifier where Flag.Value == Bool {
    let flag: Flag.Type
    private var manager = FeatureFlagManager.shared

    public init(flag: Flag.Type) {
        self.flag = flag
    }
